...
JugadoresN$Usuario[duplicated(JugadoresN$Usuario)]
...
Players %>% rename(CodigoPaisT = Pais_codigo_tres, NroPais = Numero_pais, ) -> Players
...
```{r}
# boxplot(Games$Torneos, horizontal = TRUE, col = "aquamarine", main = "Números de Torneos")
# stripchart(Games$Torneos, method = "jitter", pch = 19, add = TRUE, col = "brown1") abline(v=mean(Games$Torneos), col = "dodgerblue4") 
```
