...
Paises <- read_csv("bases_de_datos/highest_earnings/country.csv") #1 (Respecto codigo de pais)
Juegos <- read_csv("bases_de_datos/historical/GeneralEsportData.csv") #3 
Historico <- read_csv("bases_de_datos/historical/HistoricalEsportData.csv") #4
...
JugadoresIngresosT<- read_csv("bases_de_datos/players_teams/total_player_earnings.csv") #1* (Respecto usuario) 
