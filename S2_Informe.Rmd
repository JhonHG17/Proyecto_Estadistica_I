...
```{r}
hist(table(CompetitiveN$Equipo), breaks = 20, main = "CANTIDAD DE EQUIPOS GANADORES DE TORNEOS", sub = "TORNEOS POR CADA JUEGO", xlab = "Equipos", ylab = "Juegos", main = "Histograma de equipos-juegos")
```
